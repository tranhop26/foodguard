...
export interface EvidenceRecordView {
  ...
  actor_wallet: string;
  chain_id: string;
  claim_category?: EvidenceDocument["claim_category"];
  contract_address: string;
  criterion_index?: EvidenceDocument["criterion_index"];
  criterion_kind?: EvidenceDocument["criterion_kind"];
  delivery_observation?: EvidenceDocument["delivery_observation"];
  expires_at: string;
  ...
  issuer_id: string;
  item_id?: string;
  item_observations?: EvidenceDocument["item_observations"];
  nonce: string;
  observed_at: string;
  order_id: string;
  pickup_observation?: EvidenceDocument["pickup_observation"];
