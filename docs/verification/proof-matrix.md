...
| Release | Team | Project | Deployment ID | Git commit | URL | State | Live checks | Limitation |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| V1 historical | `tdh-s-projects` | `foodguard-genlayer` | `dpl_ARefQRUQS8SvbnnP3F3yu1xXAmxk` | `1d72e99d9d93f67ccbe46a12c3428fb5efd27ca9` | [`foodguard-genlayer-1fid6vo6g-tdh-s-projects.vercel.app`](https://foodguard-genlayer-1fid6vo6g-tdh-s-projects.vercel.app) | `READY` when verified | Noto Serif Vietnamese rendering and responsive layout verified | Historical immutable deployment URL; the production alias now routes to V2 |
| V2 production | `tdh-s-projects` | `foodguard-genlayer` | `dpl_BehG8SuNLuNkBjxDS1UBqLLyw7F1` | `849d630aa34b41a3703a689f7c7ac5c562af84a9` | [`https://foodguard-genlayer.vercel.app`](https://foodguard-genlayer.vercel.app) | `READY`; HTTP `200` | `/create` rendered V2 address `0xA672f8EbAdA651ad1bE6a22c0558Fc94c6422423`, omitted V1 address, and produced zero browser console errors | UI and deployment proof only; live three-wallet terminal branches remain unverified |
